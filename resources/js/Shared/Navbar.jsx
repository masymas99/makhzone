        ...
        <nav className="bg-gray-800 fixed w-full top-0 z-50 shadow-md">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:flex space-x-4">
                        ...
                        <Link href="/traders" className="px-3 py-2 rounded-md text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">العملاء</Link>
            ...
            <div className="md:hidden hidden mobile-menu">
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    ...
                    <Link href="/traders" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">العملاء</Link>
